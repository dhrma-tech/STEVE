...
export function CofounderNode({ data }: NodeProps) {
  ...
  return (
    <div className="animate-node-breath grid min-w-[210px] gap-3 rounded-[18px] border border-[rgba(238,238,232,0.34)] bg-[rgba(14,14,17,0.88)] p-4 text-center text-[var(--app-text)] shadow-[rgba(0,0,0,0.4)_0_24px_80px] backdrop-blur">
